    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'var(--bg-main)', fontFamily: "var(--font-family)" }}>
            ...
            <main style={{ flex: 1, paddingTop: '68px' }}>
                ...
                {/* Hero */}
                <section className="page-hero-shell theme-section theme-section--dark" style={{ paddingTop: '100px', paddingBottom: '90px' }}>
                    <div className="page-hero-media">
                        <video autoPlay loop muted playsInline>
                            <source src="/assets/images/about/about.mp4" type="video/mp4" />
                        </video>
                    </div>
                    <div className="page-hero-card" style={{ textAlign: 'center' }}>
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '17px', lineHeight: 1.8, maxWidth: '700px', margin: '0 auto' }}>
                ...
                {/* Main content */}
                <section className="theme-section theme-section--light" style={{ padding: '40px 40px 140px' }}>
                    <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: '60px', alignItems: 'start' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                            <div className="info-block">
                                <div style={{ fontSize: '12px', fontWeight: '800', color: 'var(--primary-light)', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: '24px' }}>Official Channels</div>
                            ...
                            <div className="info-block">
                                <div style={{ fontSize: '12px', fontWeight: '800', color: 'var(--primary-light)', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: '20px' }}>Our Offices</div>
                            ...
                            <div className="info-block">
                                <div style={{ fontSize: '12px', fontWeight: '800', color: 'var(--primary-light)', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: '20px' }}>Social Media</div>
                                <div style={{ display: 'flex', gap: '24px', fontSize: '15px', color: 'var(--primary-light)', fontWeight: '600' }}>
